...
# build redpill-lkm
cd redpill-lkm
make LINUX_SRC=../apollolake/usr/local/x86_64-pc-linux-gnu/x86_64-pc-linux-gnu/sys-root/usr/lib/modules/DSM-7.0/build prod-v7
...
./ext-manager.sh add https://raw.githubusercontent.com/rongcenter/redpill-loader-action/main/rpext-index.json
